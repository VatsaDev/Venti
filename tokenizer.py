...
files = ["data/synth/synth_part_000.txt"]
tokenizer.train(files, trainer)
tokenizer.save("tokenizers/venti_4k.json")

# full

tokenizer = PreTrainedTokenizerFast(
    tokenizer_file="tokenizers/venti_4k.json",
...
tokenizer.save_pretrained("tokenizers/venti_4k")
